            ...
            <form method="POST" action="{{ route('books.update', $book) }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description"
                              id="description"
                              rows="4"
                              class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('description', $book->description) }}</textarea>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="number"
                           ...
                           required
                           class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    <p class="text-sm text-gray-500 mt-1">Currently {{ $book->available }} of {{ $book->quantity }} available</p>
                </div>
